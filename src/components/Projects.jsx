          ...
          {projects.map(project => (
            ...
            :h-[200px] min-h-[25px] transparent rounded-md overflow-hidden'>
              <Link to={project.detailsPage} className='fill-transparent w-full h-full group2'>
                ...
                <div className='absolute w-full top-0 left-1/2 transform -translate-x-1/2 bg-gradient-to-b from-[#2e3725] to-black bg-opacity-70 text-center text-white text-lg font-bold sm:opacity-0 group2-hover:opacity-100 duration-200 rounded-md'>
                  {project.title}
                </div>
              </Link>
            </div>
