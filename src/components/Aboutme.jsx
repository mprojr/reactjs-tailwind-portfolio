    ...
    <div className='text-black'>
      <div className='max-w-[700px] py-[20px] m-auto w-full min-h-screen text-center flex flex-col'>
        ...
        <div className='m-4 grid grid-col-6'> 
          <img src="src/assets/img/PFP.jpg" alt="pfp" className='border-2 p-1 border-white col-span-4 w-56 h-56 rounded-full object-cover shadow-lg mx-auto hover:blur-sm duration-500' draggable="false" />
