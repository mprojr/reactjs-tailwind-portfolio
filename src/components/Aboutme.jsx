        ...
        */ }
        ...
        <div className='content-evenly m-3 p-3'>
          ...
          <div className='py-8 grid grid-cols-12 gap-4'>
            <span className='group border-2 border-d bg-gradient-to-t from-[#a3bc8a] to-[#77915f] opacity-85 min-h-[100px] p-4 rounded-md shadow sm:col-span-7 col-span-12'>
            ...
            <span className='flex flex-center justify-center border-2 border-solid bg-gradient-to-t from-[#a3bc8a] to-[#77915f] min-h-[100px] rounded-md bg-black shadow sm:col-span-5 col-span-12 p-4'>
